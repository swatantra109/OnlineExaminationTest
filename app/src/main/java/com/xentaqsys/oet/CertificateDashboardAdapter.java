 ...
 */
public class CertificateDashboardAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<CertificateDashboardItems> data_List;
    private Context mContext;
    public CertificateDashboardAdapter(Context context, List<CertificateDashboardItems> mDataset) {
